	...
	$.ajax({
		...
		success : function(result) {
			if ("failed" == result) {
				...
				m = eval('(' + result + ')');
				$("#updateId").val(m.id);
				$("#updateUsername").val(m.username);
				$("#updatePassword").val(m.password);
				$("#updateRealname").val(m.realname);
				$("#updateBirth").val(m.birthday);
				$("#updateTelphone").val(m.telphone);
				$("#updateAddress").val(m.address);
...
$('#updateUserBtn').click(function(e) {
	...
	$.ajax({
		type : "POST",
		url : "user/backend/updateUser.html",
		data : {
			id : $.trim($("#updateId").val()),
			username : $.trim($("#updateUsername").val()),
			realname : $.trim($("#updateRealname").val()),
			telphone : $.trim($("#updateTelphone").val()),
...
$('.updateusercancel').click(function(e) {
	$("#updateId").val('');          
	$("#updateUsername").val('');    
	$("#updatePassword").val('');    
	$("#updateRealname").val('');    
