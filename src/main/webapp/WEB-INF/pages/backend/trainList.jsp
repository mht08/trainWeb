				...
				<table class="table table-striped table-bordered bootstrap-datatable datatable">
					...
					<tbody>
						...
						<c:forEach items="${trainList }" var="train">
							<tr>
								<td><input type="checkbox" class="checkbox" name="delTrain" value="${train.id }"></td>
								<td><a class="viewtrain" id="${train.id }">${train.train_no }</a></td>
 ...
 <!-- <form action="backend/addTrain.html"  method="post" onsubmit="return addTrainFunction();" > -->
	...
	<div class="modal-body">
			<ul id="add_formtip"></ul>
               <ul class="topul">
                  <li><label>车次：</label><input type="text" id="train_no" name="train_no" value="" />
                    				<span style="color:red;font-weight: bold;">*</span></li>
                  <li><label>里程：</label><input type="text" id="mile" name="mile" value=""></li>
                  <li><label>发车：</label><input type="text" id="start_station" name="start_station" value="">
                  					<span style="color:red;font-weight: bold;">*</span></li>
                  <li><label>到达：</label><input type="text" id="arrival_station" name="arrival_station" value="">
                  					<span style="color:red;font-weight: bold;">*</span></li>
                  <li><label>发时：</label><input type="text" id="start_time" name="start_time" value="">
                  					<span style="color:red;font-weight: bold;">*</span></li>
                  <li><label>到时：</label><input type="text" id="arrival_time" name="arrival_time" value="">
                  					<span style="color:red;font-weight: bold;">*</span></li>
                  <li><label>车型：</label><input type="text" id="type" name="type" value="">
                  					<span style="color:red;font-weight: bold;">*</span></li>
                  <li><label>运行时间：</label><input type="text" id="runtime" name="runtime" value=""></li>
               </ul>
	</div>
	<div class="modal-footer">
